...
//  G4double z_mv = -1.*cm + G4UniformRand() * 0.1*cm;
...
void QuartLPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
...
void QuartLPrimaryGeneratorAction::SetOptPhotonPolar()
{
...
void QuartLPrimaryGeneratorAction::SetOptPhotonPolar(G4double angle)
{
