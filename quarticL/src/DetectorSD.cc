...
//was      G4cout <<" step->Tack is Optical Photon " <<   G4endl;
// 
...
//
//	Now, 21.01.2015
       G4cout <<  i <<" " << time/ns << " " << ecer/eV << G4endl; 
//------------------------------------------------------------------------------------
//
//
...
//--------------------------------------------------------------------------------------	
//		
// was   G4cout <<  i << time/ns << " " << ecer/eV << G4endl; 	      
