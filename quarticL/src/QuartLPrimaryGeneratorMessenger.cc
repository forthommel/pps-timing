...
//
//
// $Id: QuartLPrimaryGeneratorMessenger.cc,v 1.3 2006/06/29 17:54:29 gunter Exp $
...
{
//was  gunDir = new G4UIdirectory("/N06/gun/");
...
void QuartLPrimaryGeneratorMessenger::SetNewValue(
